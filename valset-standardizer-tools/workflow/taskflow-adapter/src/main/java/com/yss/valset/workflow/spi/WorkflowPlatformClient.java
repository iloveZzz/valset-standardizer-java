...
public interface WorkflowPlatformClient {
    ...
    WorkflowPlatformExecutionResult pause(WorkflowDefinitionDTO definition,
                                          WorkflowInstanceDTO instance,
                                          WorkflowPauseRequest request);

    WorkflowPlatformExecutionResult resume(WorkflowDefinitionDTO definition,
                                           WorkflowInstanceDTO instance,
    ...
    default String queryTaskLog(WorkflowDefinitionDTO definition, Long taskInstanceId) {
