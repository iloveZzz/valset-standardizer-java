...
public class SftpTargetConfig {
    ...
    public SftpTargetConfig(String host, int port, String username, String password, String privateKeyPath, String passphrase, String remoteDir, boolean recursive, boolean includeHidden, int limit, boolean strictHostKeyChecking, int connectTimeoutMillis, int channelTimeoutMillis) {
        this.host = host;
        this.port = port;
    ...
    public boolean equals(Object o) {
        ...
        SftpTargetConfig other = (SftpTargetConfig) o;
    ...
    @Override
    public int hashCode() {
        return java.util.Objects.hash(host, port, username, password, privateKeyPath, passphrase, remoteDir, recursive, includeHidden, limit, strictHostKeyChecking, connectTimeoutMillis, channelTimeoutMillis);
    }
    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder("SftpTargetConfig[");
