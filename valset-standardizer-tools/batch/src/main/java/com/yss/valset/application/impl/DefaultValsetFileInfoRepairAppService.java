...
public class DefaultValsetFileInfoRepairAppService implements ValsetFileInfoRepairAppService {
    ...
    public ValsetFileInfoRepairResultDTO repair(ValsetFileInfoRepairCommand command) {
        ...
        int pageIndex = 0;
        while (true) {
            TransferObjectPage page = transferObjectGateway.pageObjects(null, null, null, null, null, null, null, null, null, null, null, null,null,null,null,pageIndex, pageSize);
