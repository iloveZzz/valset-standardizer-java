 ...
 */
@Component
public class SimpleValsetMatcher implements ValsetMatcher {

    private final EmbeddingProvider embeddingProvider;

    public SimpleValsetMatcher(EmbeddingProvider embeddingProvider) {
     ...
     */
    @Override
    public List<ValsetMatchResult> matchSubjects(List<SubjectRecord> subjects, MatchContext context, int topK) {
        MatchingState matchingState = prepareState(context);
        List<ValsetMatchResult> results = new ArrayList<>(subjects.size());
     ...
     */
    @Override
    public ValsetMatchResult matchSubject(SubjectRecord subject, List<SubjectRecord> allSubjects, MatchContext context,
            int topK) {
        return matchSubjectInternal(subject, allSubjects, context, prepareState(context), topK);
    }

    private ValsetMatchResult matchSubjectInternal(
        ...
        return ValsetMatchResult.builder()
    ...
    private ValsetMatchResult emptyResult(SubjectRecord subject) {
        return ValsetMatchResult.builder()
                .externalSubjectCode(subject.getSubjectCode())
                .externalSubjectName(subject.getSubjectName())
                .externalLevel(subject.getLevel())
