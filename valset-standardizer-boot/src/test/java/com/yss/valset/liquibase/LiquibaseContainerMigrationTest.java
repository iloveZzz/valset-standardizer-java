...
class LiquibaseContainerMigrationTest {
    ...
    private void verifyMigration(String jdbcUrl, String username, String password, String tableCountSql, String indexCountSql, String mailColumnSql, String targetCountSql) throws Exception {
        ...
        try (Connection verifyConnection = DriverManager.getConnection(jdbcUrl, username, password)) {
            assertThat(scalarCount(verifyConnection, tableCountSql)).isGreaterThanOrEqualTo(12);
            ...
            assertThat(scalarCount(verifyConnection, targetCountSql)).isEqualTo(4);
        }
    }
