...
public class KnowledgeImportController {
    ...
    public KnowledgeImportResponse importStandardSubjects(@RequestPart("file") MultipartFile file,
                                                          @RequestParam(value = "dataSourceType", required = false) String dataSourceType) {
        return knowledgeImportAppService.importStandardSubjects(file, dataSourceType);
    }
    ...
    public KnowledgeImportResponse importMappingHints(@RequestPart("file") MultipartFile file) {
        return knowledgeImportAppService.importMappingHints(file);
    }
    ...
    public KnowledgeImportResponse importMappingSamples(@RequestPart("file") MultipartFile file) {
        return knowledgeImportAppService.importMappingSamples(file);
    }
}
