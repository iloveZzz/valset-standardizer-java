...
class DefaultWorkflowTaskQueryAppServiceTest {

    @Test
    void exposesExtractTaskMetricsInQueryView() {
        WorkflowTaskGateway taskGateway = mock(WorkflowTaskGateway.class);
        ObjectMapper objectMapper = new ObjectMapper();
        DefaultWorkflowTaskQueryAppService service = new DefaultWorkflowTaskQueryAppService(taskGateway, objectMapper);

        when(taskGateway.findById(99L)).thenReturn(WorkflowTask.builder()
                .taskId(99L)
        ...
        assertThat(view.getRowCount()).isEqualTo("114");
        assertThat(view.getFileSizeBytes()).isEqualTo("53760");
        assertThat(view.getDurationMs()).isEqualTo("1234");
    ...
    void exposesReadableErrorMessageForFailedTask() {
        ...
        when(taskGateway.findById(100L)).thenReturn(WorkflowTask.builder()
                .taskId(100L)
