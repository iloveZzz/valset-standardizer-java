package com.yss.subjectmatch.domain.exporter;
...
public interface ResultExporter {
     ...
     * 导出匹配工件。
     */
    void exportMatchResults(Long taskId, ParsedValuationData parsedValuationData, List<SubjectMatchResult> results);
