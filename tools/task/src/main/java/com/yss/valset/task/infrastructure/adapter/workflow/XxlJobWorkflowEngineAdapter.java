 ...
 */
@Component
public class XxlJobWorkflowEngineAdapter implements WorkflowEngineAdapter {

    @Override
    public WorkflowEngineType engineType() {
        return WorkflowEngineType.XXL_JOB;
    }
    ...
    public void trigger(String workflowCode, String stageCode, Map<String, Object> context) {
        throw new UnsupportedOperationException("XXL_JOB 平台暂未接入执行能力");
    }
    ...
    private void validateType(WorkflowExecutorBindingDTO binding) {
        ...
        if (!WorkflowEngineType.XXL_JOB.name().equalsIgnoreCase(binding.getEngineType())) {
