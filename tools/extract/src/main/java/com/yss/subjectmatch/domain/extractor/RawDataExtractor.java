package com.yss.subjectmatch.domain.extractor;
 ...
 * </p>
 *
 * @see com.yss.subjectmatch.domain.model.DataSourceConfig
 * @see com.yss.subjectmatch.domain.model.DataSourceType
 */
public interface RawDataExtractor {
     ...
     * @param fileId 文件标识
     * @return 成功提取并持久化的总行数
     * @throws com.yss.subjectmatch.domain.exception.FileAccessException 文件无法打开或读取时抛出
