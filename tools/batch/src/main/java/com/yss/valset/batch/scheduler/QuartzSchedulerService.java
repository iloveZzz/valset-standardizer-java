...
import com.yss.valset.batch.job.DispatchJob;
import org.quartz.*;
...
public class QuartzSchedulerService implements SchedulerService {
    ...
    private static final String JOB_GROUP = "valset-standardizer-job";
    private static final String TRIGGER_GROUP = "valset-standardizer-trigger";
