...
public interface TransferObjectMapper extends TransferMapstructSupport {
    ...
    @Mapping(target = "businessDate", expression = "java(transferObject.businessDate())")
    @Mapping(target = "businessId", expression = "java(transferObject.businessId())")
    @Mapping(target = "receiveDate", expression = "java(transferObject.receiveDate())")
    @Mapping(target = "probeResultJson", expression = "java(transferJsonMapper.toCompactJson(transferObject.probeResult()))")
    @Mapping(target = "fileMetaJson", expression = "java(transferJsonMapper.toCompactJson(transferObject.fileMeta()))")
    ...
    @Mapping(target = "businessDate", expression = "java(po.getBusinessDate())")
    @Mapping(target = "businessId", expression = "java(po.getBusinessId())")
    @Mapping(target = "receiveDate", expression = "java(po.getReceiveDate())")
