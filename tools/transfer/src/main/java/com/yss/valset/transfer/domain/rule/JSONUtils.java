...
public final class JSONUtils {
    ...
    public static <T> T parseObject(String json, Class<T> clazz) {
        ...
        try {
            ...
            log.error("JSON EOF exception - unexpected end of input, jsonStr: {}, class: {}, error: {}", json, clazz, e.getMessage());
        } catch (com.fasterxml.jackson.core.JsonParseException e) {
            log.error("JSON parse exception - invalid JSON format, jsonStr: {}, class: {}, error: {}", json, clazz, e.getMessage());
        } catch (Exception e) {
    ...
    public static <T> T parseObject(String json, TypeReference<T> type) {
        ...
        try {
            ...
            log.error("JSON EOF exception - unexpected end of input, jsonStr: {}, type: {}, error: {}", json, type.getType(), e.getMessage());
        } catch (com.fasterxml.jackson.core.JsonParseException e) {
            log.error("JSON parse exception - invalid JSON format, jsonStr: {}, type: {}, error: {}", json, type.getType(), e.getMessage());
        } catch (Exception e) {
            log.error("Parse object exception, jsonStr: {}, type: {}", json, type.getType(), e);
        }
