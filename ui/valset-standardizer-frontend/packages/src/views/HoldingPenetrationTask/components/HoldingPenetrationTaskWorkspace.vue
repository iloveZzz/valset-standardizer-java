...
const confirmExecute = (row: HoldingPenetrationTaskBatchRow) => {
  openActionConfirm(
...
const confirmRetry = (row: HoldingPenetrationTaskBatchRow) => {
  openActionConfirm(
...
const confirmStop = (row: HoldingPenetrationTaskBatchRow) => {
  openActionConfirm(
...
const openHistory = (row: HoldingPenetrationTaskBatchRow) => {
  page.openHistoryDrawer(row);
};

const confirmRetryStep = (row: HoldingPenetrationTaskStepRow) => {
  openActionConfirm(
    ...
    <div>
      <YCard class="outsourced-task-filter" :bordered="false" :padding="12">
        <a-form
          layout="inline"
          size="small"
          class="outsourced-task-filter__form"
        >
