...
import { useSpringBatchValuationTaskMonitorPage } from "./hooks/useSpringBatchValuationTaskMonitorPage";
import {
...
defineOptions({ name: "SpringBatchValuationTaskMonitorPage" });

const { page } = useSpringBatchValuationTaskMonitorPage();
...
const selectRow = (row: SpringBatchValuationTaskBatchRow) => {
...
const retryStep = (step: SpringBatchValuationTaskStepRow) => {
  confirmAction(
    "重跑 Batch Step",
