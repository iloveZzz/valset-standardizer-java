...
export const getJavaSpringBootQuartzApi = () => {
   ...
   */
  const upload1 = (upload1Request: Upload1Request) => {
    const formData = new FormData();
    formData.append("file", upload1Request.file);
    if (upload1Request.dataSourceType !== undefined) {
      formData.append("dataSourceType", upload1Request.dataSourceType);
    }
    if (upload1Request.createdBy !== undefined) {
      formData.append("createdBy", upload1Request.createdBy);
    }
    if (upload1Request.forceRebuild !== undefined) {
      formData.append("forceRebuild", upload1Request.forceRebuild.toString());
    }
